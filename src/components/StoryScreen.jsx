...
import { Input, Typography, Card, Space, message, Spin } from 'antd';
...
const StoryScreen = () => {
  ...
  const proceedToTeamSetup = async () => {
    ...
    try {
      // Submit story to API
      const result = await dispatch(submitStoryToAPI(storyText));
